...
class Sproite(pygame.sprite.Sprite):
    ...
    def change_color(self, new_color):
        ...
        pygame.draw.rect(self.image, new_color, [0, 0, self.rect.width, self.rect.height])
...
while running:
    ...
    if pygame.sprite.spritecollide(sprite1, pygame.sprite.Group(sprite2), False):
        sprite1.change_color(pygame.Color("Yellow"))
        sprite2.change_color(pygame.Color("Cyan"))
    else:
        sprite1.change_color(pygame.Color("black"))
        sprite2.change_color(pygame.Color("Red"))
