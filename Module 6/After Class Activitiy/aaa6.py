...
background_image = pygame.image.load('C:\\Users\\madhu\\OneDrive\\Documents\\Python Courses\\Module 6\\After Class Activitiy\\Kholi.jpg')
pygame.display.set_caption("Player and Enemies Collision")
pygame.mixer.Sound.play(pygame.mixer.Sound('C:\\Users\\madhu\\OneDrive\\Documents\\Python Courses\\Module 6\\After Class Activitiy\\background.mp3'))
...
while True:
    ...
    if collided_enemies:
        ...
        pygame.mixer.Sound.play(pygame.mixer.Sound('C:\\Users\\madhu\\OneDrive\\Documents\\Python Courses\\Module 6\\After Class Activitiy\\bomb.wav'))
